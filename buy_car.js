...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
 console.log(startPriceOld, "start");
 console.log(percentLossByMonth, "rate");
 var count = 0;
 var saving = 0;
 var priceOld = startPriceOld;
 var priceNew = startPriceNew;
 while ((priceOld + saving) < priceNew){
percentLossByMonth += (count % 2 === 1?0.5 : 0);
 console.log(percentLossByMonth, "each rate");
 ...
 return [count, Math.round((priceOld + saving) - priceNew)];
}